...
namespace TaskTrackerBLL.Interfaces.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<Result<ProfileDto>> GetProfileAsync(int id)
        {
            ...
            if (user is null)
            {
                return Result<ProfileDto>.Failure($"User with ID {id} was not found.");
            }
        ...
        // =========================================================
        public async Task<Result> UpdateProfileAsync(UpdateProfileDto input)
        {
        ...
        public async Task<Result> ChangePasswordAsync(int userId,string currentPassword,string newPassword)
        {
            ...
            // -----------------------------------------------------
            var passwordValid =_passwordHasher.VerifyPassword(user.PasswordHash,currentPassword);
            if (!passwordValid)
            {
